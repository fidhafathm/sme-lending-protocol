    ...
    <div className="card-hover">
      ...
      {canExecute && (
        <div className="space-y-3">
          <div className="card bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30">
...
export default function Members() {
  ...
  return (
    <div className="space-y-8">
        ...
        <div>
          ...
          {error && (
            <div className="mb-4 p-4 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 ">
              ...
              {error.cause && (
                <p className="text-xs text-gray-600 dark:text-gray-500 mt-1">Cause: {error.cause.toString()}</p>
              )}
            </div>
          )}
          ...
          {!isConnected ? (
            <div className="card text-center py-12">
              <Vote className="w-12 h-12 text-gray-400 dark:text-gray-700 mx-auto mb-4" />
              <p className="text-sm text-gray-700 dark:text-gray-400">
            ...
            <div className="card text-center py-12">
              <Vote className="w-12 h-12 text-gray-400 dark:text-gray-700 mx-auto mb-4" />
              <p className="text-sm text-gray-700 dark:text-gray-400 mb-2">No membership proposals yet</p>
      ...
      {activeTab === 'members' && (
        <div className="card text-center py-12">
          <Users className="w-12 h-12 text-gray-400 dark:text-gray-700 mx-auto mb-4" />
        ...
        <div className="max-w-2xl">
          <div className="card-bordered">
            ...
            <div className="space-y-5">
              ...
              {!isConnected && (
                <p className="text-sm text-center text-gray-700 dark:text-gray-600">
